  ...
  _________________________________________________________ -->
              ...
              <div class="col-md-9">
                  <div class="box">
                      ...
                      <?php echo form_open('account/address/'); ?>
                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control" name="default_address" id="default_address">
                                      ...
                                      <?php else:?>
                                        <select class="form-control" disabled name="default_address" id="default_address">
                                            <option value="">Agrega una Dirección</option>
                                  <?php endif;?>
                                  </select>
                                </div>
                            </div>
                          ...
                          </form> <!-- ./ form_open('account/activate_address') -->
                        </div>
                      ...
                      </form><!-- /.form_open('account/verify_address_change') -->
