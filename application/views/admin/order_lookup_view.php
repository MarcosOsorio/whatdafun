            ...
            <div id="content">
                <div class="container">
                    ...
                    <div class="box">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <?php echo form_open('admin/update_tracking')?>
                          <div class="col-md-6">
                            <label for="tracking_number">Nº de Seguimiento</label>
                            <input type="text" name="tracking_number" class="form-control" maxlength="11" required placeholder="ingrese número de seguimiento">
                          </div>

                          <div class="col-md-6">
                            <label for="shipment_id">Presione para Actualizar</label>
                            <input type="hidden" name="purchase_id" value="<?php echo $purchase->pur_id;?>">
                            <button type="submit" name="shipment_id" value="<?php echo $purchase->shi_id;?>"class="form-control btn btn-primary"><i class="fa fa-save"></i>Guardar</button>
                          </div>
                          <?php echo form_close();?>
                        </div>
                      </div>
